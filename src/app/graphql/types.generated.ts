import type { ID } from '../../modules/shared/mod.ts';
import type { EmailAddress as Email } from '../../modules/shared/mod.ts';
import type { GraphQLResolveInfo, GraphQLScalarType, GraphQLScalarTypeConfig } from 'graphql';
import type { TodoDto } from '../../modules/todo/app.ts';
import type { UserDto } from '../../modules/user/app.ts';
...
export type Scalars = {
  ...
  EmailAddress: { input: Email; output: Email; }
...
export type ResolversTypes = ResolversObject<{
  ...
  Todo: ResolverTypeWrapper<TodoDto>;
