...
import type { Dto } from "../../application/dtos/todo.ts";
...
import type { PageInfo } from "../types.generated.ts";
...
describe("order of items", () => {
  ...
  const patterns: [UserTodosArgs, [Dto, Dto, Dto]][] = [
    [
...
describe("filter by status", () => {
  ...
  const patterns: [UserTodosArgs, Dto[]][] = [
    [
      {
        first: FIRST_MAX,
        reverse: false,
