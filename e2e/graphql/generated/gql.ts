...
const documents: Documents = {
    ...
    "\n    mutation RefreshTokenReuseAccessTokenRefresh($refreshToken: String!) {\n      accessTokenRefresh(refreshToken: $refreshToken) {\n        __typename\n        ... on AccessTokenRefreshSuccess {\n          accessToken\n          refreshToken\n        }\n        ... on InvalidRefreshTokenError {\n          message\n        }\n        ... on RefreshTokenReuseError {\n          message\n        }\n      }\n    }\n  ": types.RefreshTokenReuseAccessTokenRefreshDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    mutation RefreshTokenReuseAccessTokenRefresh($refreshToken: String!) {\n      accessTokenRefresh(refreshToken: $refreshToken) {\n        __typename\n        ... on AccessTokenRefreshSuccess {\n          accessToken\n          refreshToken\n        }\n        ... on InvalidRefreshTokenError {\n          message\n        }\n        ... on RefreshTokenReuseError {\n          message\n        }\n      }\n    }\n  "): typeof import('./graphql.js').RefreshTokenReuseAccessTokenRefreshDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
